...
[TABLE IS A PLACEHOLDER--WILL REPLACE WITH A CUSTOM DESIGN TO MINIMIZE TEXT IN IMAGE]
...
| Example: A financial aid worker needs to check someone’s eligibility for student grants. You don’t need to look at someone’s full medical history. | Example: A financial aid worker needs to check someone’s eligibility for student grants. You don’t need to look at someone’s full medical history. |
