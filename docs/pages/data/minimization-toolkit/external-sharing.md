...
description: Share data responsibly, especially when external parties request it
...
### 1. Understand your legal authority
...
* Name the exact [data elements](https://csrc.nist.gov/glossary/term/data_element) you will share.
...
[Map where the data lives](/data/minimization-toolkit/conducting-risk-necessity-assessments/#how-to-evaluate-risk) can help you make a data inventory.
...
* Red flags that require escalation (such as [spending clause coercion](https://www.law.cornell.edu/constitution-conan/article-1/section-8/clause-1/anti-coercion-requirement-and-spending-clause) like funding threats or retroactive conditions).
...
### 2. Escalate to legal counsel and department leadership right away
