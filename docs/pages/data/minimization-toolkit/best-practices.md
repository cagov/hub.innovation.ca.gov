---
layout: page
title: Best practices for data minimization
parentid: Data minimization toolkit
parentidlink: /data/minimization-toolkit/
description: Set up your data rules and collection practices
...
* Simplify and protect sensitive data. For example, split sensitive data from identifying information in storage. The Massive Data Institute has [quick improvements for data privacy](https://mdi.georgetown.edu/quick-improvements-to-data-privacy/). Your department may already have rules for this. They are called the Secretary of State approved retention schedule.
...
Use [plain language](/content-design/plain-language-equity-standard/) to tell the people or groups whose data is being collected about:
